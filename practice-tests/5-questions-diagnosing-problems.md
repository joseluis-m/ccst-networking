...
B) Meraki es una plataforma de gestión de red basada en la nube, donde el tráfico de datos de usuario NO pasa por la nube del fabricante
C) Meraki requiere acceso por console a cada dispositivo para funcionar
D) Meraki solo gestiona routers, no switches ni APs

<respuesta>
✅ Correcta: B) Meraki es una plataforma de gestión de red basada en la nube, donde el tráfico de datos de usuario NO pasa por la nube del fabricante
...
**Pregunta 27. [Hotspot]**
*Descripción: Se muestra la siguiente salida del comando `show ip route` en un router Cisco:*
...
**Pregunta 28. [Hotspot]**
*Descripción: Se muestra la siguiente salida del comando `show interfaces status` en un switch Cisco:*
...
B) Fa0/2 — estado "notconnect" indica que no hay enlace físico (cable desconectado o impresora apagada)
C) Fa0/3 — la impresora está en VLAN 10 en lugar de VLAN 1
D) Fa0/4 — el AP Wi-Fi está consumiendo todo el ancho de banda

<respuesta>
✅ Correcta: B) Fa0/2 — estado "notconnect" indica que no hay enlace físico (cable desconectado o impresora apagada)
...
**Pregunta 29. [Hotspot]**
*Descripción: Se muestra la siguiente salida del comando `show cdp neighbors` en un router:*
...
**Pregunta 30. [Hotspot]**
*Descripción: Un usuario de Windows ejecuta `ipconfig /all` y obtiene la siguiente salida:*
